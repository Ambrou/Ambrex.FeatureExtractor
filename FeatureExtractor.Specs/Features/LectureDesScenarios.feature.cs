...
#line 45
 testRunner.Then("j\'ai l\'exigence ESD_044 avec comme texte \"Gestion des informations dans la barre " +
                    "de statusstatuts [p.29]\" et titre \"Utilisation de la bibliothèque IO_Image pour " +
                    "définir les zones de ROI [p.15]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 46
     testRunner.And("j\'ai l\'exigence ESD_544 avec comme texte \"Gestion des informations dans la barre " +
                    "de status           statuts [p.29]\" et titre \"Utilisation de la bibliothèque IO_" +
                    "Image pour définir les zones de ROI [p.15]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden

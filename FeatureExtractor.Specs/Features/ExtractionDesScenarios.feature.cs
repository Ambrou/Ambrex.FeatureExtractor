...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ExtractionDesScenarios", "  In order to manipulate Requirement\'s scenarios as easily as moving shit around\n" +
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Extraction d\'un plan de scénario simple sans indication de plan de scénario dans " +
            "le texte")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "ExtractionDesScenarios")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("extraction")]
        public virtual void ExtractionDUnPlanDeScenarioSimpleSansIndicationDePlanDeScenarioDansLeTexte()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Extraction d\'un plan de scénario simple sans indication de plan de scénario dans " +
                    "le texte", new string[] {
                        "extraction"});
#line 47
this.ScenarioSetup(scenarioInfo);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Extraction d\'un plan de scénario complexe sans indication de plan de scénario dan" +
            "s le texte")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "ExtractionDesScenarios")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("extraction")]
        public virtual void ExtractionDUnPlanDeScenarioComplexeSansIndicationDePlanDeScenarioDansLeTexte()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Extraction d\'un plan de scénario complexe sans indication de plan de scénario dan" +
                    "s le texte", new string[] {
                        "extraction"});
#line 59
this.ScenarioSetup(scenarioInfo);
#line hidden
